...
| [`n8n/import-manifest.json`](n8n/import-manifest.json) | 17 workflow JSON (`full_clean_import_set`), bindings, credentials |
...
Clean import: `n8nio/n8n:2.30.8`, 17 JSON из `full_clean_import_set`, `active=0`.
