...
- Workflows: [`workflows/`](workflows/) — `core/` live MAS (9 JSON) + `support/` templates + `retired/` archive (**не импортировать**).
