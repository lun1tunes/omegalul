...
SPEC = AgentSpec(
    ...
    when_to_use=(
        ...
        "новый .INC и список изменений. Не вызывать, если инженер просит посчитать модель на гидродинамическом "
        "кластере или применить уже готовое расписание к модели на кластере — это другой агент."
    ),
